      ...
      <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
        <form action="/register" method="POST" id="registration-form">
          ...
          <div class="form-group">
            ...
            @error('username')
              <p class="m-0 small alert aler-danger shadow sm">{{$message}}</p>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input name="password_confirmation" value="{{old('password')}}" id="password-register-confirm" class="form-control" type="password" placeholder="Confirm password" />
            @error('password')
              <p class="m-0 small alert aler-danger shadow sm">{{$message}}</p>
            @enderror
          </div>
